...
use backend\models\Sales;
 ...
 <!-- <td><?php echo $autonumber;?></td>-->
  <td><?php echo "<b>Stockname: </b>".$product_data -> productname;echo "<br>";
   ...
   echo "<b> Brand Code : </b>".$skdata -> brandcode;echo "&nbsp; &nbsp; &nbsp; &nbsp;";
	echo Html::input('hidden', 'brandcode[]', $skdata -> brandcode);
    echo "<b>Stock Code : </b> ". $skdata -> stockcode;echo "<br>";
	echo Html::input('hidden', 'stock_code[]', $skdata -> stockcode);
     echo "<b> Batch Number : </b>" .$k -> batchnumber;echo "&nbsp; &nbsp; &nbsp; &nbsp;";
 ...
 <input type="text" min="0" name="totalunits[]" dataincrement="<?php echo $i; ?>"  value="0" class="form-control totalunits" required="true" readonly="true" placeholder="Total Units" id="totalunits<?php echo $i; ?>"  style="text-align:right;"/>
  ...
  <td>
 <input type="text" min="0" name="priceperqty[]" dataincrement="<?php echo $i; ?>" value="<?php echo number_format($custommrp,2); ?>" class="form-control itemprice" required="true" placeholder="Price" id="item_price_ep<?php echo $i; ?>"  style="text-align:right;"/>
...
<?php } ?>
 ...
 <td>
 	<table><tr><td>Flat <input class="discounttype" id="discounttype<?php echo $i; ?>" name="discounttype<?php echo $i; ?>" value="flat" type="radio" checked="true"></td>
 		<td>% <input class="discounttype" id="discounttype<?php echo $i; ?>" name="discounttype<?php echo $i; ?>" value="percent"  type="radio" ></td></tr>
 ...
 <td><button type='button' data-id='productrowdata<?php echo $autonumber; ?>'  dataincrement="<?php echo $i;?>" class='btn btn-xs btn-icon btn-danger waves-effect waves-light deleteproduct_ep' >
