               ...
               'template'=>'{view}{pdf}{procedurerefunds}',
                            'buttons'=>[
                              'view' => function ($url, $model, $key)
							   {
                                $url= Url::to(['in-registration/views', 'id' => ($model -> id)]);
								 ...
								 'pdf' => function ($url, $model, $key) 
								   {
										...
										$url= Url::to(['in-registration/report', 'id' => ($model -> id)]);
									...
									'procedurerefunds' => function ($url, $model, $key) 
								   {
										...
										$url= Url::to(['in-registration/procedure-refunds', 'id' => urlencode(base64_encode(($model -> id)))]);
