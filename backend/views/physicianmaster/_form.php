...
<div class="col-md-2">
    <?= $form->field($model, 'qualification')->textInput(['maxlength' => true]) ?>
     ...
     <div class="col-md-4">
  		...
  		echo $form->field($model, 'specialist')->dropDownList($speciallist,['prompt'=>'--Select Specialist--','data-live-search'=>'true','data-style'=>'btn-default btn-custom','class'=>'form-control selectpicker']);
		 }
		else {
