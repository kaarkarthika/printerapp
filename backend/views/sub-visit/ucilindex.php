...
<div class="newpatient-index">
 <?php Pjax::begin(); ?>
        ...
        [
         ...
         ['class' => 'yii\grid\ActionColumn',
             ...
             'contentOptions' => ['style' => 'width:5%;color:#337ab7;'],
               'template'=>'{view}{update}{overallreport}',
                            'buttons'=>[
								   ...
								   'update' => function ($url, $model) 
								   {
                                		...
                                		$options = array_merge([
                                            ...
                                            'data-toggle'=>'tooltip',
                                            'title' => Yii::t('yii', 'Update Patient'),
                                            'aria-label' => Yii::t('yii', 'Update Patient'),
                                            'data-pjax' => '0',
                                            'style'=>'margin-right:4px;',
                                        ]);
										$url= Url::to(['sub-visit/ucilupdate', 'id' =>  urlencode(base64_encode($model->sub_id)),'pat_id'=>urlencode(base64_encode($model->pat_id))]);
                                        return Html::a('<span class="fa fa-edit"></span>', $url, $options);
                                	
                                	                                
            						},
            						
									'overallreport' => function ($url, $model) 
								   {
                                		
                                		$options = array_merge([
                                            'class' => 'btn btn-success btn-xs upload gridbtncustom',
                                            'data-toggle'=>'tooltip',
                                            'title' => Yii::t('yii', 'Overall Report'),
                                            'aria-label' => Yii::t('yii', 'Overall Report'),
                                            'data-pjax' => '0',
                                            'style'=>'margin-right:4px;',
                                            'target'=>'_blank',
                                        ]);
										...
										$url= Url::to(['sub-visit/printres', 'id' =>  urlencode(base64_encode($model->sub_id)),'pat_id'=>urlencode(base64_encode($model->pat_id)),'date_ucil'=>$model->created_at]);
		...
		/*  [
		  ...
		  [	'attribute' => 'ucil_date', 
		   ...
		   [	'attribute' => 'phone_number', 
                ...
                if($model->mr_number != '')
				{
					$new=Newpatient::find()->where(['mr_no'=>$model->mr_number])->one();
						return $new->pat_mobileno;  
				}
				else if($model->mr_number == '')
				{
					  	return '-';  
				}
    ...
    //'floatHeaderOptions'=>['scrollingTop'=>'50'],
		...
		'panel' => [
        'heading'=>'<h3 class="panel-title"><i class="fa fa-building-o" aria-hidden="true"></i> UCIL GRID</h3>',
        'type'=>'success',
