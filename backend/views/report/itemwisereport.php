...
<!-- <div class="panel-heading" style="border-top: 3px solid #5fbeaa!important;">Itemwise Purchase Report</div> -->      
   ...
   <div class='col-md-3'>
    ...
    <select id="product_idz" class="selectpicker " name="Productname[id][]" multiple="" size="4" title="Select Product" required data-style="btn-default btn-custom cus-fld" data-live-search="true" aria-required="true" tabindex="-98" aria-invalid="false" >
...
<!-- <div class="panel-heading" style="border-top: 3px solid #5fbeaa!important;">Itemwise Sales Report</div>       -->
    ...
    <?= Html::submitButton('', ['class' => 'btn btn-success btn-sm fa fa-print','style'=>'position:relative;top:20px','name'=>"Pricelist","value"=>4,"data-toggle"=>"tooltip","title"=>"PriceList"]) ?>
     ...
     <?php ActiveForm::end(); ?>
     <?php $form = ActiveForm::begin(['action'=>['expiryreport'],'options' =>['target'=>'_blank']]); ?>
     <div class='col-md-6'>
	 <fieldset class="scheduler-border col-sm-12">
	 <legend class="scheduler-border form-head ">Nearing Expiry Report </legend>
	 	<div class='col-md-5'>
        <div class=" ">
        	<label>From</label>
   ...
   <div class='col-md-12'>
    ...
    <select id="vendor_idz" class="selectpicker " name="Vendorname[id][]" multiple="" size="4" title="Select Vendor" required data-style="btn-default btn-custom cus-fld" data-live-search="true" aria-required="true" tabindex="-98" aria-invalid="false" >
    	
		<?php foreach($vendorname as $key => $value ){ ?>
				<option value="<?php echo $key; ?>"><?php echo $value;?></option>	
		<?php } ?>
      ...
      <div class='col-md-2'>
    <?= Html::submitButton('', ['class' => 'btn btn-success btn-sm fa fa-print','style'=>'position:relative;top:20px','name'=>"Supplier","value"=>5,"data-toggle"=>"tooltip","title"=>"Supplier"]) ?>
    </div>
    </div>
   ...
   <div class='col-md-6'>
    ...
    <div class='col-md-2'>
    <?= Html::submitButton('', ['class' => 'btn btn-success btn-sm fa fa-print','style'=>'position:relative;top:20px','name'=>"GST","value"=>6,"data-toggle"=>"tooltip","title"=>"GST Purchase Report"]) ?>
    </div>
   ...
   <?php ActiveForm::end(); ?>
    ...
    <div class='col-md-2'>
    <?= Html::submitButton('', ['class' => 'btn btn-success btn-sm fa fa-print','style'=>'position:relative;top:20px','name'=>"sales_GST","value"=>7,"data-toggle"=>"tooltip","title"=>"GST Sales Report"]) ?>
    </div>
   ...
   <?php ActiveForm::end(); ?>
    ...
    <div class='col-md-12'>
    	<div class='col-md-6'>
     <?php $form = ActiveForm::begin(['action'=>['summarizedgstpurchase'],'options' =>['target'=>'_blank']]); ?>
	 <fieldset class="scheduler-border col-sm-12">
	<legend class="scheduler-border form-head ">Summarized Purchase Report</legend>
    ...
    <div class='col-md-2'>
    <?= Html::submitButton('', ['class' => 'btn btn-success btn-sm fa fa-print','style'=>'position:relative;top:20px','name'=>"sales_purchased","value"=>7,"data-toggle"=>"tooltip","title"=>"GST Sales Report"]) ?>
    </div>
   ...
   <?php ActiveForm::end(); ?>
    ...
    <div class='col-md-6'>
     <?php $form = ActiveForm::begin(['action'=>['summarizedgstsales'],'options' =>['target'=>'_blank']]); ?>
	 <fieldset class="scheduler-border col-sm-12">
	<legend class="scheduler-border form-head ">Summarized Sales Report</legend>
...
<script type="text/javascript">
 ...
 format: 'DD-MM-YYYY HH:mm:ss'
       ...
       $('#datetimepicker29').datetimepicker({
		 ...
		 $("#datetimepicker28").on("dp.change", function (e) {
            $('#datetimepicker29').data("DateTimePicker").minDate(e.date);
        });
        $("#datetimepicker29").on("dp.change", function (e) {
