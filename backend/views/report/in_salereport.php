...
<h4 class="page-title"> <?= Html::encode($this->title) ?></h4>
							 ...
							 <?php  echo $this->render('_insalessearch', ['model' => $searchModel,'patienttypelist'=>$patienttypelist,"insurancetypelist"=>$insurancetypelist]); ?>
<div class="row">
<div class="col-sm-12">
               ...
               'template'=>'{print}',
                    ...
                    'print' => function ($url, $model, $key) {
                      ...
                      return Html::a('<span class="btn btn-purple btn-xs btn-flat waves-effect waves-light" style="margin-right:4px;">Invoice',
                       ['in-sales/invoice','id'=>$model->opsaleid], ["target"=>"_blank","data-pjax"=>"0",'data-toggle'=>'tooltip','title' =>'Bill Invoice']);
                                        } }},
                          ] ],
        ],
    ]); ?>
...
<script>
    $(document).ready(function(){
     $('body').on("click",".modalView",function(){
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-th-large"></i>View IP Sales</span>');
