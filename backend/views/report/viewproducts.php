...
<tr><td><?php  echo Html::a('<i class="fa fa-file-excel-o"></i> Export Excel ', ['composition/exceldownload','id'=>$model->composition_id,'name'=>$cdata->composition_name], ['class' => 'btn btn-info btn-sm pull-right']); ?></td></tr>
