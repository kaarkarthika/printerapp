...
$this->title = Yii::t('app', 'IP Sales Return');
...
<div class="panel-body">
	 <?php  echo $this->render('_inreturnreportsearch', ['model' => $searchModel]); ?>
...
<script>
    $(document).ready(function(){
     $('body').on("click",".modalView",function(){
             ...
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-th-large"></i>View IP Sale Details</span>');
