               ...
               'template'=>'{print}',
                            'buttons'=>[
                                  ...
                                  if(in_array('print', $session[Yii::$app->controller->id])) {    
                                        ...
                                        return Html::a('<span class="btn btn-purple btn-xs btn-flat waves-effect waves-light" style="margin-right:4px;">Invoice', ['sales/returntabletbill','id'=>$model->return_id], ["target"=>"_blank", "data-pjax"=>"0", 'data-toggle'=>'tooltip', 'title' =>'Return Bill Invoice' ]);
                                        } }},
                          ] ],
        ],
    ]); ?>
