...
<div class="col-sm-6">
	<h4 class="page-title"> <?= Html::encode($this->title) ?></h4> <ol class="breadcrumb" >
		...
		<div class="col-sm-6" >
								<?= Html::a('Manage Grouping ', ['addcreate'], ['class' => 'btn btn-default btn-right']) ?>
							</div>
						</div>
        ...
        'columns' => [
          ...
          // 'autoid',
           ...
           // ['attribute' => 'price', 
            ...
            'value'=> function($model)
			{
				$group_list_tbl=LabTestgroup::find()->where(['testgroupid'=>$model->autoid])->asArray()->count(); 
...
<script>
 $('body').on("click",".addcat",function(){ 
         ...
         $('body').on("click",".modalView",function(){
             ...
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-th-large"></i>View Test Group</span>');
