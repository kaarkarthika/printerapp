...
<script>
 $('body').on("click",".addcat",function(){ 
             ...
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-plus"></i> Group Master</span>');
         ...
         $('body').on("click",".modalView",function(){
             ...
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-th-large"></i> Group Master</span>');
             $('#operationalmodal').modal('show').find('#modalContenttwo').load(url);
             return false;
         });
          $('body').on("click",".updatedata",function(){
             var url = $(this).attr('value');
            $('#operationalheader').html('<span> <i class="fa fa-fw fa-edit"></i> Group Master</span>');
             $('#operationalmodal').modal('show').find('#modalContenttwo').load(url);
             return false;
