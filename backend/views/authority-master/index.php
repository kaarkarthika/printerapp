...
/* @var $searchModel backend\models\AuthorityMasterSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Authority Masters';
...
<div class="col-sm-6">
	...
	<div class="row">
		    <?= Html::a('Create Authority Master', ['create'], ['class' => 'btn btn-success addcat']) ?>
	</div>
...
<div class="authority-master-index">
...
<script>
    $(document).ready(function(){
             ...
             var PageUrl = '<?php echo Yii::$app->homeUrl;?>?r=authority-master/create';
             
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-plus"></i>Add Authority</span>');
             $('#operationalmodal').modal('show').find('#modalContenttwo').load(PageUrl);
             return false; });
     $('body').on("click",".modalView",function(){
          
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-th-large"></i>View Authority</span>');
             $('#operationalmodal').modal('show').find('#modalContenttwo').load($(this).attr('value'));
             return false;  });

 	  $('body').on("click",".updatedata",function(){
            
            $('#operationalheader').html('<span> <i class="fa fa-fw fa-sitemap"></i> Update Authority</span>');
                  $('#operationalmodal').modal('show').find('#modalContenttwo').load($(this).attr('value'));
             return false;});
