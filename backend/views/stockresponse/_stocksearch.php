...
<span class="input-group-addon bg-custom b-0 text-white"> <span class="glyphicon glyphicon-th"></span></span>
...
<div class="clearfix"></div>
    ...
    <div class="col-md-12">
      ...
      <?= Html::a(Yii::t('app', 'Reset'), Url::toRoute([]), ['class' => 'btn btn-warning pull-right','style'=>'margin-right: 2%;']) ?>
 <br><br>
 <hr>
			<?php 
if(isset($_GET['StockresponseSearch']['productname']) && ($_GET['StockresponseSearch']['productname']!="") ||
