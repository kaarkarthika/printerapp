							...
							<div class="col-sm-12">
								<div class="panel panel-border panel-custom">
									<div class="panel-heading">
										<a class="btn btn-success" style="float: right;" href="<?php echo Yii::$app->homeUrl . "?r=stockrequest/receive";?>">Back to Receive</a>
									</div>
          ...
          //   'purchaseprice',
           //  'priceperquantity',
            ...
            // 'sales_status',
               ...
               'header'=> 'Action',
                'headerOptions' => ['style' => 'width:140px;color:#337ab7;'],
