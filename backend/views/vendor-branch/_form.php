...
<div class="row">
				<div class="col-md-1 pull-right">
					<?= Html::submitButton($model -> isNewRecord ? Yii::t('app', 'Save') : Yii::t('app', 'Update'), ['class' => $model -> isNewRecord ? 'btn btn-success btn-cutsom tabind' : 'btn btn-primary  tabind','tabindex' => 1019]) ?>
				</div>
				</div>
