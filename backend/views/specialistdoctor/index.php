     ...
     <?= GridView::widget([
        ...
        'columns' => [
           ...
           // 'specialist',
			 ...
			 ['attribute' => 'ucil_amount', 'format'=>'raw', 'value' => function($model){return ucfirst($model->ucil_amount);}],
...
<script>
    $(document).ready(function(){
             ...
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-plus"></i> Specialist</span>');
     ...
     $('body').on("click",".modalView",function(){
 	  ...
 	  $('body').on("click",".updatedata",function(){
            ...
            $('#operationalheader').html('<span> <i class="fa fa-fw fa-sitemap"></i> Specialist</span>');
                  $('#operationalmodal').modal('show').find('#modalContenttwo').load($(this).attr('value'));
             return false;});
