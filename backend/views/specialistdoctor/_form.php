...
<div class="row specialistdoctor-form">
    ...
    <div class="col-md-6">
	 ...
	 <div class="col-md-6">
     <?= $form->field($model, 'ucil_amount')->textInput(['maxlength' => true]) ?>
	</div>
...
<hr>
     <div class="form-group col-md-12">
        ...
        <?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-fw fa-save"></i>Save' : '<i class="fa fa-fw fa-edit btn-xm"></i>Update', ['class' => $model->isNewRecord ? 'btn btn-success pull-right special btn-xm' : 'btn btn-primary pull-right updatespecial']) ?>
		<?= Html::Button('<i class="fa fa-fw fa-close"></i> Close', ['class' => 'btn btn-danger pull-right closez btn-xm', 'data-dismiss'=>"modal" ,'aria-hidden'=>"true",'style'=>'margin-right: 2%;']) ?>
