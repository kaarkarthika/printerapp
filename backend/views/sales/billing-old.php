               ...
               <div class="row">
                     ...
                     <div class="col-sm-12"     >
						...
						<div class="col-sm-3">
						 <div class="form-group col-sm-7 " >
                           ...
                           <div class="input-group add-on fwidth" >
                           		<input class="form-control mrn inrefrsh number" placeholder="MRN Search" name="mr_number" onkeyup="Patient_details(event)"   id="mrnumber" type="text" tabindex="8">
						...
						<div class="form-group col-sm-5" style="position: relative;  z-index: 1;    padding: 0;">
							<button type="button" style="float: left;background: #800080 !important;   margin-right: 5px;" class="btn  btn-sm" id="patient_history_detils" disabled onclick='Patient_modal()'><i class="glyphicon glyphicon-user" aria-hidden="true"></i> </button>
						    <button type="button" class="btn btn-primary btn-sm" id="history_detils">Details</button>
			...
			if($('.get_slno').val() == '')
			{
				...
				for (var i=0; i < arr.length; i++)
				{
					...
					else
					{
						...
						$('#total_net_amount').val(total_net_amount_final);
