...
<h4 class="page-title"> <?= Html::encode($this->title) ?></h4>
 ...
 {
 echo Html::a(Yii::t('app', 'Add Sales'), ['create'], ['class' => 'btn btn-default pull-right waves-effect waves-light', 'style'=>"margin-bottom: 5px;"]);
 }
 } ?>
               ...
               'template'=>'{view}{opreturns}{print}',
                            'buttons'=>[
                              ...
                              'opreturns' => function ($url, $model) 
                              {
									...
									$url= Url::to(['sales/opreturns', 'id' =>  urlencode(base64_encode($model -> opsaleid))]);
