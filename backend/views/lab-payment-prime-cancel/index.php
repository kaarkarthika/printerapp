...
/* @var $searchModel backend\models\LabPaymentPrimeCancelSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Lab Payment Prime Cancels';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="lab-payment-prime-cancel-index">
    ...
    <p>
        <?= Html::a('Create Lab Payment Prime Cancel', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
