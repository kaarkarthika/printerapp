...
use backend\models\AdminThemeVersion;
		...
		$version_data = AdminThemeVersion::find()->orderBy(['timestamp'=>SORT_DESC])->where(['reconcileversionkey'=>'reconcileversion'])-> one();
		if($version_data){$viewversion = $version_data -> reconcileversionname. '  ' . $viewversion = $version_data -> reconcileversion;  }
  ...
  <footer class="footer text-right">
                  © <?php echo date("Y"); ?> DMC PHARMACY . All rights reserved.
                </footer>
