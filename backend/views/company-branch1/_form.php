  ...
  ?>
    ...
    <div class="clearfix"></div>
     ...
     <div class="form-group col-md-12">
        ...
        <?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-fw fa-save"></i>Save' : '<i class="fa fa-fw fa-edit"></i>Update', ['class' => $model->isNewRecord ? 'btn btn-success waves-effect pull-right waves-light tabind' : 'btn btn-primary pull-right branch waves-effect waves-light tabind','style'=>'margin-left: 0%;','tabindex' => 1013]) ?>
