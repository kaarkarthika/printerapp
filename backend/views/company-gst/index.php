...
/* @var $searchModel backend\models\CompanyGstSearch */
...
<div class="container">
 	...
 	<div class="row">
                	 ...
                	 echo Html::button(' Add GST',['class' => 'hide btn btn-default  addgst waves-effect waves-light',]);
...
<?php Pjax::begin(['id'=>'gst-grid']); ?>    <?= GridView::widget([
        ...
        'columns' => [
         ...
         ['attribute'=>'state','headerOptions'=>['style'=>'color:#337ab7;']],
          'gst',
            //'isactive',
            // 'updatedby',
            // 'updatedon',
...
<script>
    $(document).ready(function(){
         	...
         	$('body').on("click",".addgst",function(){
             var PageUrl = '<?php echo Yii::$app->homeUrl;?>?r=company-gst/create';
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-plus"></i>Add GST</span>');
          ...
          $('body').on("click",".modalView",function(){
             ...
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-th-large"></i>GST Details</span>');
             $('#operationalmodal').modal('show').find('#modalContenttwo').load(PageUrl);
             return false();
 	...
 	$('body').on("click",".updatedata",function(){
       ...
       // $('#modal').modal('show').find('#modalContent').load($(this).attr('value'));
            $('#operationalheader').html('<span> <i class="fa fa-fw fa-edit"></i>Update GST</span>');
