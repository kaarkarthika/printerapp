...
<div class="module-action-form">
  ...
  <div class="form-group" align="">
  	<div class="col-md-12">
	     <hr>
	     <?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-fw fa-save"></i>Save' : '<i class="fa fa-fw fa-edit"></i>Update', ['class' => $model->isNewRecord ? 'btn pull-right btn-success modact' : 'btn btn-primary pull-right modact']) ?>
	
  		<?= Html::Button('<i class="fa fa-fw fa-close"></i> Close', ['class' => 'btn pull-right btn-danger closez', 'data-dismiss'=>"modal" ,'aria-hidden'=>"true",'style'=>'margin-right: 2%;']) ?>
