...
<div class="col-sm-12">
 ...
 {
 echo Html::button(' Add Vendor',['class' => 'btn btn-default waves-effect waves-light addvendor  ']);
 }
 } ?>
</div>
...
<?php Pjax::begin(['id'=>'vendor-grid']); ?>    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['attribute' => 'vendorname', 'format'=>'raw', 'value' => function($model){return ucfirst($model->vendorname);}],
            'vendorcode', ['attribute' => 'is_active', 'filter'=>array("1"=>"Yes","0"=>"No"), 'format'=>'raw', 'value' => function($model){
...
<script>
    $(document).ready(function(){
             ...
             var PageUrl = '<?php echo Yii::$app->homeUrl;?>?r=vendor/create';
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-plus"></i>Add Vendor</span>');
     ...
     $('body').on("click",".modalView",function(){
 	  ...
 	  $('body').on("click",".updatedata",function(){
            ...
            $('#operationalheader').html('<span> <i class="fa fa-fw fa-sitemap"></i> Update Vendor</span>');
                  $('#operationalmodal').modal('show').find('#modalContenttwo').load($(this).attr('value'));
             return false();});
