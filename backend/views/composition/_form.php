...
<div class="row composition-form">
  ...
  <hr>
     ...
     <?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-fw fa-save"></i>Save' : '<i class="fa fa-fw fa-edit"></i>Update', ['class' => $model->isNewRecord ? 'btn btn-success pull-right composition' : 'btn btn-primary pull-right updatecomposition','style'=>'margin-left: 0%;']) ?>
