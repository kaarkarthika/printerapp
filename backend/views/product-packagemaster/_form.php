   ...
   <div class="row" >
      <div class="col-sm-12">
         <div class="panel panel-border panel-custom">
			...
			<div class="row">
               <div class=" col-md-3">
                  <?= $form->field($model, 'pack_name')->textInput(['required' => true]) ?>
               </div>
               <div class=" col-md-3">
                  <?php 
	   ...
	   <div class="panel panel-border panel-custom">
	    ...
	    <div class="col-sm-12">
                  <div class="form-group  ">
                     <?= Html::Button('Save',['class' => 'btn btn-success b-width','onclick'=>'SaveProduct();']) ?>
                  </div>
...
'<td class="text-center"><button data-id='+productid+' onclick="ProductRemove('+productid+');" class="remove btn btn-danger btn-xs productremove" id="productremove'+productid+'" type="button"><i class="glyphicon glyphicon-remove" aria-hidden="true"></i></button></td>'+
'</tr>';
