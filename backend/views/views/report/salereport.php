            ...
            // 'updated_ipaddress',
               ...
               'template'=>'{print}',
                    ...
                    'print' => function ($url, $model, $key) {
                      ...
                      return Html::a('<span class="btn btn-purple btn-sm btn-rounded waves-effect waves-light" style="margin-right:4px;">Invoice',
                       ['sales/invoice','id'=>$model->opsaleid], ["target"=>"_blank","data-pjax"=>"0",'data-toggle'=>'tooltip','title' =>'Invoice']);
                                        } }},
                          ] ],
        ],
    ]); ?>
