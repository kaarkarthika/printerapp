...
<?php
$productid="";$vendorid="";$compositionid="";$stockcode="";$brandcode="";$expdate="";
...
?>
 ...
 isset($_GET['StockmasterSearch']['stockcode']) && ($_GET['StockmasterSearch']['stockcode']!="") || 
  isset($_GET['StockmasterSearch']['expiredate']) && ($_GET['StockmasterSearch']['updated_ipaddress']!="") || 
 isset($_GET['StockmasterSearch']['brandcode']) && ($_GET['StockmasterSearch']['brandcode']!="")){
 	echo '<table class="table  table-striped"><tr><td width="800px"></td><td>';
       echo Html::a('<i class="fa fa-file-pdf-o"></i> Export Pdf ', ['stockmaster/exportpdfdownload' ,'productid'=>$productid, 'vendorid'=>$vendorid, 'compositionid'=>$compositionid,'brandcode'=>$brandcode,'stockcode'=>$stockcode,'expdate'=>$expdate], 
 ...
 isset($_GET['StockmasterSearch']['brandcode']) && ($_GET['StockmasterSearch']['brandcode']!="")){
       ...
       'vendorid'=>$vendorid, 'compositionid'=>$compositionid,'brandcode'=>$brandcode,'stockcode'=>$stockcode,'expdate'=>$expdate,], ['class' => 'btn btn-danger btn-sm ','target'=>'_blank']); 
      echo '</td>
