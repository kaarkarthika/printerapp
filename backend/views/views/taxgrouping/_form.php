  ...
  <!--  <?= $form->field($model, 'updated_by')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'updated_ipaddress')->textInput(['maxlength' => true]) ?>-->
       ...
       <div class="form-group col-md-12" style="padding-top:30px;">
        ...
        <?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-fw fa-save"></i>Save' : '<i class="fa fa-fw fa-edit"></i>Update', ['class' => $model->isNewRecord ? 'btn btn-success taxgroup' : 'btn btn-primary updatetaxgroup']) ?>
