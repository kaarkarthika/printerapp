...
<div class="container" style="height:500px;">
    ...
    'onchange'=>'   $.get( "'.Url::toRoute('getproduct').'", { id: $(this).val() } )
					...
					<div class="col-md-3">
						...
						<?= Html::Button($model->isNewRecord ? '<i class="fa fa-fw fa-plus"></i> Add' : '<i class="fa fa-fw fa-edit"></i>Update', ['class' => $model->isNewRecord ? 'btn btn-danger productgrouping' : 'btn btn-primary updateproductgrouping','style'=>'margin-left: 0%;'])
						?>
					</div>
...
window.location.href= '<?php echo Yii::$app -> homeUrl; ?>?r=productgrouping/index';
	}
	});
	}
