...
<div class="clearfix"></div>
 ...
 <div class="clearfix"></div>
     ...
     <div class="form-group col-md-12 ">
        ...
        <?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-fw fa-save"></i>Save' : '<i class="fa fa-fw fa-edit"></i>Update', ['class' => $model->isNewRecord ? 'btn btn-default waves-effect waves-light' : 'btn btn-primary waves-effect waves-light','style'=>'margin-left: 0%;']) ?>
