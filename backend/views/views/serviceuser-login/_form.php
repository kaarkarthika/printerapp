...
<div class="col-md-6">
    ...
    'template' => "<div class='checkbox checkbox-danger' style='margin-top:30px;'>{input}<label>$module_value->moduleName</label></div>{error}",
])->checkbox(['name'=>'assignservice[]','id'=>'ser','class'=>$class,'label'=>$module_value->moduleName,'value'=>$module_value->p_autoid,'selected'=>true],false);
echo '</td>';
   ...
   echo "</tr>";
    ...
    <div class="form-group col-md-12">
       ...
       <?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-fw fa-save"></i>Save' : '<i class="fa fa-fw fa-edit "></i>Update', ['class' => $model->isNewRecord ? 'btn btn-default add_rights waves-effect' : 'btn btn-primary add_rights  waves-effect','style'=>'margin-bottom: 2%;']) ?>
