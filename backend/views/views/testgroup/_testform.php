...
<div class="testgroup-form">
    ...
    <tbody>
     ...
     <?php  if(array_key_exists($value['autoid'],$array_index_key)) { ?> 
   			
   			<td style="text-align: center;"> <input type="checkbox" class="check_class" name="Checked[]" checked value="<?php echo $value['autoid'];?>"></td>
    <?php }else{ ?>
