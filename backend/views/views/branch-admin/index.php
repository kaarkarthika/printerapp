...
<?php Pjax::end(); ?>
    ...
    $(document).ready(function(){
             ...
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-plus"></i>Add Branch Admin</span>');
 	...
 	$('body').on("click",".updatedata",function(){
       ...
       // $('#modal').modal('show').find('#modalContent').load($(this).attr('value'));
            $('#operationalheader').html('<span> <i class="fa fa-fw fa-edit"></i>Update Branch Admin</span>');
