...
.unit_val button.btn.btn-xs.btn-danger {
    TOP: 26px;
    POSITION: RELATIVE;
    LEFT: 5px;
    PADDING: 5px 10px;
...
<div class="goback_product">
	<a class="btn waves-effect " onclick="goBack()">Go Back</a>
</div>
<div class="row">
<div class="col-sm-12">
...
<span type="button" class="btn waves-effect waves-light btn-default"><i class="fa fa-product-hunt"></i></span>
    ...
    <?php 
     ...
     echo $form->field($model, 'product_typeid')->dropDownList($items,['prompt'=>'--Select Product Type--','data-live-search'=>'true','class'=>'form-control selectpicker tabind','tabindex'=>1002 ,'data-style'=>'btn-default btn-custom', 'onchange'=>'
  	...
  	<?php 
    	 echo $form->field($model, 'hsn_code')->dropDownList($taxgrouping,['prompt'=>'--Select HSN Code--','data-live-search'=>'true','class'=>'form-control selectpicker tabind','tabindex'=>1003 ,'data-style'=>'btn-default btn-custom', 'onchange'=>'
   ...
   <div class="clearfix"></div>
    ...
    <div class="col-md-4 ">
    <?= $form->field($model, 'composition_id')->dropDownList($composition,['prompt'=>'--Select Composition--','data-live-search'=>'true','data-style'=>'btn-default btn-custom','class'=>'form-control selectpicker tabind','tabindex'=>1004 ]);?>
    </div>
   ...
   echo $form->field($model, 'unit')->dropDownList([],['prompt'=>'--Select Unit--','data-live-search'=>'true','data-style'=>'btn-default btn-custom','class'=>'form-control selectpicker tabind ' ,'id'=>'unit','tabindex'=>1005]);
	...
	<button type="button" class='btn btn-xs btn-danger addvendor'><i class="fa fa-plus"></i></button>
    </div>
...
['prompt'=>'--Select Manufacturer--','class'=>'form-control selectpicker tabind','tabindex'=>1007,'data-style'=>'btn-default btn-custom','data-live-search'=>'true'])->label('Manufacturer') ?>
   </div>
   <div class="clearfix"></div>
      <div class="col-md-4">
...
<span type="button" class="btn waves-effect waves-light btn-default"><i class="fa fa-product-hunt"></i></span>
  ...
  <div class="col-md-4">
    <?= $form->field($model, 'sort_description')->textArea(['class'=>'form-control tabind',  'tabindex'=>1011,'maxlength' => true,'placeholder'=>'Description']) ?>
    	...
    	<?php if($model->isNewRecord){
			...
			echo '<button class="btn btn-default waves-effect waves-light btn-lg">'.$code.'</button>';
  ...
  <?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-fw fa-save"></i>Save' : '<i class="fa fa-fw fa-edit "></i>Update', ['class' => $model->isNewRecord ? 'btn btn-warning products tabind' : 'btn btn-primary updateproduct tabind fetch_data','tabindex'=>1012]) ?>
 </div>
   <div class="clearfix" ></div>
