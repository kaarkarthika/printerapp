...
<div class="panel-body">
  ...
  <?= $form->field($model, 'vendorid')->dropdownlist($list,['prompt'=>'Select Vendor','id'=>'vendor_idz','required'=>'true','class'=>'selectpicker','data-live-search'=>'true','data-style'=>"btn-default btn-custom", 'onchange'=>'
                                                    $.get( "'.Url::toRoute('getproduct').'", { id: $(this).val(),branchid:$("#branchid").val() } )
                                                        .done(function( data ) {
   ...
   'onchange'=>'
	  ...
	  <div class="col-md-3 form-group" style="margin-top: 26px;">
        <?= Html::Button(' Add Direct Stock', ['class' => 'fa fa-plus btn btn-default waves-effect waves-light addstock']) ?>
    </div>
	 <?php ActiveForm::end(); ?>
