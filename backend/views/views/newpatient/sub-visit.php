      ...
      <tr>
        ...
        <td><?php echo $model->pat_mobileno; ?></td>
  		...
  		<fieldset class="scheduler-border">
			...
			<br>
			<div class="row">
				 <?= $form->field($subvisit, 'patient_type')->dropDownList($patienttype, ['title'=>'Patient Type','class' => '  form-control','onchange'=>'Patienttypemodule(this.value);'])->label('Patient Type') ?>
						 
				 <?= $form->field($subvisit, 'insurance_type')->dropDownList($insurancelist,['prompt' => '-SELECT-' ,'class' => '  form-control','onchange'=>'UCIL(this.value);'])->label('Insurance Type') ?>
			</div>
  		...
  		<fieldset class="scheduler-border">
			...
			<div class="row ">
					...
					<?php 
    					 	...
    					 	<?= $form->field($subvisit, 'consultant_time')->dropDownList(['Evening' => 'Evening', 'Morning' => 'Morning'],['options' => ['Morning' => ['selected'=>true]],'maxlength' => true ,'class' => '  form-control w-cus','placeholder'=>'Timing','tabindex'=>359,'required'=> true])->label('Timing') ?>
 						<?php }else if(date('A',strtotime($today_date)) == 'PM') { ?>
 						 	<?= $form->field($subvisit, 'consultant_time')->dropDownList(['Evening' => 'Evening', 'Morning' => 'Morning'],['options' => ['Evening' => ['selected'=>true]],'maxlength' => true ,'class' => '  form-control w-cus','placeholder'=>'Timing','tabindex'=>359,'required'=> true])->label('Timing') ?>
 						<?php } ?>
				...
				<?= $form->field($subvisit, 'department')->dropDownList($specialistdoctor,['prompt'=>'-Specialized-','maxlength' => true ,'class' => '  form-control w-cus','placeholder'=>'Department','tabindex'=>361,'required'=> true,'readonly'=> true])->label('Department') ?>
  		...
  		<fieldset class="scheduler-border">
			...
			<div class="row field-subvisit">
 				...
 				<?= $form->field($subvisit, 'less_disc_percent')->textInput(['maxlength' => true ,'class' => ' number form-control w-cus number','placeholder'=>'Less Disc(%)','tabindex'=>364,'onblur'=>'Discountcalculation(this.value);','disabled'=>true])->label('LesDis(%)') ?>
				...
				<?= $form->field($subvisit, 'paid_amt')->textInput(['maxlength' => true ,'class' => ' number form-control w-cus number','placeholder'=>'Paid Amount','tabindex'=>367,'onblur'=>'Paidflatcalculation(this.value);','disabled'=>true])->label('Paid Amt') ?>
 				...
 				<?= $form->field($subvisit, 'pay_mode')->dropDownList($paymenttype,['placeholder'=>'Pay Mode','maxlength' => true ,'class' => '  form-control w-cus','placeholder'=>'Pay Mode','tabindex'=>369,'disabled'=>true])->label('Pay Mode') ?>
  		...
  		<fieldset class="scheduler-border">
			...
			<div class="row field-subvisit">
 				...
 				<?= $form->field($subvisit, 'less_disc_flat')->textInput(['maxlength' => true ,'class' => ' number form-control w-cus number','placeholder'=>'Less Discount','tabindex'=>365,'onblur'=>'Discountflatcalculation(this.value);'])->label('Less Disc') ?>
				...
				<?= $form->field($subvisit, 'paid_amt')->textInput(['maxlength' => true ,'class' => ' number form-control w-cus number','placeholder'=>'Paid Amount','tabindex'=>367,'onblur'=>'Paidflatcalculation(this.value);'])->label('Paid Amt') ?>
 				...
 				<?= $form->field($subvisit, 'pay_mode')->dropDownList($paymenttype,['placeholder'=>'Pay Mode','maxlength' => true ,'class' => '  form-control w-cus','placeholder'=>'Pay Mode','tabindex'=>369])->label('Pay Mode') ?>
