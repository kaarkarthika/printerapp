...
$this->title = Yii::t('app', 'Transfer Stock Return');
?>
<div class="container" >
<div class="row">
<div class="col-sm-12">
                            ...
                            'buttons'=>[
                              'view' => function ($url, $model, $key) {
                                ...
                                'update' => function ($url, $model) {
                              	$url=Yii::$app->homeurl."?r=transferstock/transferstockreturn&id=".$model->transferstockid;
                              	$session = Yii::$app->session;
								if($session[Yii::$app->controller->id]!=""){
                                  if(in_array('e', $session[Yii::$app->controller->id])) {
									...
									$status=$model->status;
									  if($status!="Returned")
									  {
									  	 return Html::a('<span class=" btn btn-flat btn-danger btn-xs" style="margin-right:4px;">Return</span>', $url,$options);  
									  }      
