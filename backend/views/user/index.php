...
<div class="col-sm-12">
 <div class="btn-group pull-right m-t-15">
  <?php
    ...
    echo Html::a('Add User', ['create'],['class' => 'btn btn-default waves-effect waves-light']);
...
<div class="panel-body">
  <?php Pjax::begin(['id'=>'physician-grid']); ?> 
    <?= GridView::widget([
                            ...
                            'buttons'=>[
                                ...
                                'update' => function ($url, $model, $key) {
                                        ...
                                        $options = array_merge([
                                         ...
                                         $url= Url::to(['user/update', 'id' =>  urlencode(base64_encode($model -> id))]);
