...
<div class="panel-body">
	<?php $form = ActiveForm::begin(); ?>
	 <div class=" col-md-12">
		...
		<div class=" col-md-3">
			<?= Html::submitButton($model->isNewRecord ? '<i class="fa fa-fw fa-save"></i>Save' : '<i class="fa fa-fw fa-edit"></i>Update', ['class' => $model->isNewRecord ? 'btn btn-success waves-effect waves-light' : 'btn btn-primary branch waves-effect waves-light','style'=>'position:relative;top:23px']) ?>
