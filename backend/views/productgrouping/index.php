...
<?php Pjax::begin(['id'=>'productgroup-gst']); ?>    <?= GridView::widget([
        ...
        'columns' => [
          ...
          /*  ['attribute' =>'vendorid',
            'value'=>'vendor_name',
            'filter'=>Html::activeDropDownList($searchModel,'vendorid',$vendorlist,
            ['class'=>'form-control','prompt' =>'--Vendor--']),],
				*/
		...
		[
            ...
            'headerOptions' => ['style' => 'color:#337ab7;'],
             'label'=>'Vendor',
            'width'=>'310px',
            'value'=>function ($model, $key, $index, $widget) { return $model->vendor->vendorname;},
            'filterType'=>GridView::FILTER_SELECT2,
            'filter'=>$vendorlist, 
            'filterWidgetOptions'=>['pluginOptions'=>['allowClear'=>true]],
            'filterInputOptions'=>['placeholder'=>'--Search Vendor--'],
        ],
...
'stock_code','brandcode',
		...
		[
            ...
            'headerOptions' => ['style' => 'color:#337ab7;'],
             'label'=>'Product',
            'width'=>'310px',
            'value'=>function ($model, $key, $index, $widget) { return $model->product->productname;},
            'filterType'=>GridView::FILTER_SELECT2,
            'filter'=>$productlist, 
            'filterWidgetOptions'=>['pluginOptions'=>['allowClear'=>true]],
            'filterInputOptions'=>['placeholder'=>'--Search Product--'],
        ],
