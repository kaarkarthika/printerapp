						 ...
						 <div class="form-group col-sm-9">
						   ...
						   <div class="input-group input-group-sm add-on mr-num">	   
							     <div class="field-mrnumber has-success"> 
								  <?= $form->field($model, 'ip_no')->textInput(['class'=>'ipnumber ip-btn-style cus-fld number','autocomplete'=>"off",'maxlength' => true,'required'=> true])->label(false) ?>
                                    <input type="hidden" id="pat_id" name="PATID">
                                    <input type="hidden" id="subvisit_id" name="SUBVISITID">
                                    <input type="hidden" id="subvisit_number" name="SUBVISITNUMBER">
						   	      </div>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="input-group">
                                          ...
                                          <?= $form->field($model, 'overalldiscountpercent')->textInput(['class'=>'form-control w-40  number pr-11 text-right','onkeyup'=>'DiscountPercentCalCulation(this,event);'])->label('Less Discount(%)')->label('') ?>
                                          <div class="input-group-btn" data-toggle="buttons">
                                          ...
                                          <?= $form->field($model, 'overalldiscountamount')->textInput(['class'=>'form-control cus-fld number pr-11 text-right','onkeyup'=>'DiscountValueCalCulation(this,event);'])->label('')  ?>
...
function PatientDetailsFetch(data)
{
	$.ajax({
        type: "POST",
        url: "<?php echo Yii::$app->homeUrl . "?r=in-treatment-overall/ajaxipnumberselectblockipentriesdata&id=";?>"+data,
        success: function (result) 
        { 
        	var obj = $.parseJSON(result);
        
        /*	if(obj[2]['insurance_type']){
        		var insurance="-";
        	}else{
        	var insurance=obj[2]['insurance_type'];	
        	}*/
     ...
     //   	$('#intreatmentoverall-insurancetype').val(insurance);
        	$('#newpatient-par_relationname').val(obj[0]['religion']);
