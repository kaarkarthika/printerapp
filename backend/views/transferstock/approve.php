...
$this->title = Yii::t('app', 'Transfer Stock Approve');
?>
<div class="container" >
<div class="row">
<div class="col-sm-12">
...
<?php Pjax::begin(); ?>    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'groupEvenCssClass'=>'kv-grouped-row', // configure even group cell css class
             ...
             ['attribute'=>'transferstockquantity','label'=>'Request Quantity', 'headerOptions' => ['style' => 'color:#337ab7;width:100px;']],
             ...
             ['label' => 'Transfer Stock Date','attribute' => 'transferstockdate','value'=>function($model){return date("d-m-Y",strtotime($model->transferstockdate)); },
            'filterType'=> kartik\grid\GridView::FILTER_DATE, 'filterWidgetOptions' => ['options' => ['placeholder' => 'Select date'],
                           'pluginOptions' => ['format' => 'd-m-yyyy','todayHighlight' => true ]],
               ],
                            ...
                            'buttons'=>[
                              'view' => function ($url, $model, $key) {
                                ...
                                'update' => function ($url, $model) {
                              	$url=Yii::$app->homeurl."?r=transferstock/transferstockapprove&id=".$model->transferstockid;
                              	$session = Yii::$app->session;
								if($session[Yii::$app->controller->id]!=""){
                                  if(in_array('e', $session[Yii::$app->controller->id])) {
									  ...
									  if($status!="Approved")
									  {
									  	  return Html::a('<span class=" btn btn-flat btn-danger btn-xs" style="margin-right:4px;">Approve</span>', $url,$options); 
									  }
