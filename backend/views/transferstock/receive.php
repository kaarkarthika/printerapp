...
$this->title = Yii::t('app', 'Transfer Stock Receive');
...
<?php Pjax::begin(); ?>    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['attribute'=>'transferstockquantity','label'=>'Request Quantity'],
             ['attribute'=>'unitname','headerOptions' => ['style' => 'color:#337ab7;']],
               ['attribute'=>'total_no_of_quantity','label'=>'Request Total Quantity'],
               
               [  'label' => 'ReceiveDate',
            'attribute' => 'approvedateval',
            'headerOptions' => ['style' => 'color:#337ab7;'],
          'value'=>function($model){return date("d-m-Y",strtotime($model->approvedateval)); },
                            ...
                            'buttons'=>[
                              'view' => function ($url, $model, $key) {
                                ...
                                'update' => function ($url, $model) {
                              	$url=Yii::$app->homeurl."?r=transferstock/transferstockreceive&id=".$model->transferstockid;
                              	$session = Yii::$app->session;
								if($session[Yii::$app->controller->id]!=""){
								...
								$status=$model->status;
									  if($status!="Received")
									  {
									  	 return Html::a('<span class=" btn btn-flat btn-danger btn-xs" style="margin-right:4px;">Receive</span>', $url,$options); 
									  }      
