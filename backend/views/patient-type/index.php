...
<div class="col-sm-12">
 ...
 <?php echo Html::button('Add Patient Type',['class' => 'btn btn-default waves-effect waves-light addspecial']); ?>
</div>
...
<script>
    $(document).ready(function(){
             ...
             var PageUrl = '<?php echo Yii::$app->homeUrl;?>?r=patient-type/create';
             
             $('#operationalheader').html('<span> <i class="fa fa-fw fa-plus"></i> Patient Type</span>');
     ...
     $('body').on("click",".modalView",function(){
 	  ...
 	  $('body').on("click",".updatedata",function(){
            ...
            $('#operationalheader').html('<span> <i class="fa fa-fw fa-sitemap"></i> Patient</span>');
                  $('#operationalmodal').modal('show').find('#modalContenttwo').load($(this).attr('value'));
             return false;});
