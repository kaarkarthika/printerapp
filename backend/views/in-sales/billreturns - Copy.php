   ...
   <div class="row">
	  ...
	  <strong><span class="pull-right" id="date_time"></span></strong>
			...
			<legend class="scheduler-border form-head ">PATIENT DETAILS</legend>
	 		...
	 		<div class='col-md-2' style="width: 10%;">
    			<div class="form-group">
        			<label>BILL NO</label>
            		<input type='text' class="form-control ipnumber cus-fld" autocomplete="off"  name="BILLNUMBER" >
        ...
        <div class='col-md-2' style="width: 8%;">
          <div class="form-group">
              <label>IP NO</label>
                <input type='text'   class="form-control cus-fld" readonly id="ip_no" name="IPNUMBER">
        ...
        <?php // $form->field($model, 'ip_no')->textInput(['class'=>'ipnumber form-control cus-fld number','autocomplete'=>"off",'maxlength' => true,'required'=> true])->label('IP NO') ?>
   			...
   			<div class='col-md-2' style="width: 8%;">
    			<div class="form-group">
        			<label>MR NO</label>
            		<input type='text'   class="form-control cus-fld" id="mrnumber" readonly  name="MRNUMBER">
				</div>
   			</div>
   			<div class='col-md-2 width-inc' >
    			<div class="form-group">
        			<label>PAT NAME</label>
            		<input type='text'  class="form-control cus-fld" id='patient_name'  readonly name="PATIENTNAME">
				</div>
   			</div>
   			<div class='col-md-2' style="width: 10%;">
    			<div class="form-group">
        			<label>MOB NO</label>
            		<input type='text' class="form-control cus-fld" readonly id="mobile_number" name="MOBILENUMBER">
				</div>
   			</div>
   			<div class='col-md-2 width-inc'>
    			<div class="form-group ">
                ...
                <input type='text' class="form-control cus-fld" onclick="isReadOnly()"  readonly id="doctor_name" name="DOCTORNAME">
               ...
               <input type='text' class="form-control cus-fld" onclick="isReadOnly()"  readonly id="insurance" name="INSURANCE">
	 		...
	 		<div class='col-md-2' style="width: 10%;">
    			<div class="form-group">
        			<label>DOB</label>
            		<input type='text' class="form-control cus-fld" id="dob" readonly name="PATIENTDOB">
				</div>
   			</div>
   			<div class='col-md-2' style="width: 10%;">
    			<div class="form-group">
        			<label>GENDER</label>
              <input type='text' class="form-control cus-fld" id="gender" readonly name="GENDER">
  ...
  {  $('#load1').show();
    $.ajax({
          ...
          {   
            ...
            $('#dob').val(formatDate(data[0]['dob']));
            $('#patient_name').val(data[0]['patient_name']);
            //$('#blockipentries-age').val(Agecalc(data[0]['dob']));
            $('#gender').val(data[0]['gender']);
            $('#doctor_name').val(data[0]['physicianname']);
            $('#insurance').val(data[0]['insurancetype']);
           
            $('#mobile_number').val(data[0]['phone_no']);

            // $('#product_name').append('<option value="1">One</option>');
                //  $('#product_name').html('');
                   $('#product_name').html('<option value="">' + '</option>'); 
               $.each(data[1], function(k, v) {
                 $('#product_name').append('<option value="' + v['salesauto_id'] + '">' + v['productname'] + '</option>'); 
