...
/**
 * LabPaymentPrimeCancelSearch represents the model behind the search form of `backend\models\LabPaymentPrimeCancel`.
 */
class LabPaymentPrimeCancelSearch extends LabPaymentPrimeCancel
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = LabPaymentPrimeCancel::find();
