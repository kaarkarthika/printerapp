...
/**
 * SalesMoneyreceiptsSearch represents the model behind the search form of `backend\models\SalesMoneyreceipts`.
 */
class SalesMoneyreceiptsSearch extends SalesMoneyreceipts
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            [['autoid'], 'integer'],
            [['mr_no', 'total_paid', 'name', 'mobile_no', 'bill_number', 'pancard_no', 'cardholder_name', 'service_tax', 'prev_cashpaid', 'bill_amount', 'amount', 'total_amount', 'mode_of_payment', 'card_cheque_no', 'card_name', 'bank_name', 'payment_details', 'amount_in_words', 'remark', 'default_amount', 'status', 'created_at', 'updated_at', 'user_id', 'authority', 'ip_address', 'updated_ipaddress'], 'safe'],
        ];
    }
