...
/**
 * This is the model class for table "proc_can_individual".
 *
 ...
 */
class ProcCanIndividual extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['user_id', 'ipaddress'], 'string', 'max' => 255],
        ];
    }
