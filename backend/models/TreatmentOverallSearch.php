...
/**
 * TreatmentOverallSearch represents the model behind the search form about `backend\models\TreatmentOverall`.
 */
class TreatmentOverallSearch extends TreatmentOverall
{
    /**
     * @inheritdoc
     */
    public function rules()
    {
        return [
            ...
            [['refund_status', 'name', 'dob', 'physicianname', 'mrnumber', 'patient_id', 'subvisit_id', 'subvisit_num', 'insurancetype', 'address', 'phonenumber', 'billnumber', 'invoicedate', 'overalldiscounttype', 'user_id', 'user_role', 'created_at', 'updated_at', 'ipaddress'], 'safe'],
