...
function showCalender(elPos, tgtEl)
{
	...
	var calTable = document.getElementById('calenderTable1');
...
{
	var calTBody = document.getElementById('calendernew');
...
function hideSelect(el, superTotal)
{
	...
	for (var c=0; c<totalChilds; c++)
	{
		...
		if (thisTag.tagName == 'SELECT')
		{
			...
			{
				var calenderEl = document.getElementById('calenderTable1');
				var positions = [0,0];
...
function closeCalender()
{
	...
	document.getElementById('calenderTable1').style.display='none';
}
