...
(function(b) {
            ...
            if (!this.grid) {
                    ...
                    g = {
                        ...
                        dragMove: function(e) {
                            if (this.resizing) {
                                ...
                                var i =
                                    c.direction === "ltr" ? e.width + d : e.width - d,
                                    n;
                                if (i > 33) {
                                    this.curGbox.css({
                                ...
                                if (n) {
                                    ...
                                    if (y)
                                        if (!(c.lastpage && t > c.lastpage || c.lastpage == 1 || t === c.page && t === c.lastpage))
                                            if (g.hDiv.loading) g.timer = setTimeout(g.populateVisible, c.scrollTimeout);
                                            else {
                                                c.page = t;
                                                if (x) {
                        ...
                        selectionPreserver: function(e) {
                            ...
                            d.gridComplete = function() {
                                ...
                                if (d.multiselect && n && n.length > 0)
                                    for (var s = 0; s < n.length; s++) n[s] != i && b(e).jqGrid("setSelection", n[s], false);
                ...
                if (this.tagName !=
                    ...
                    if (this.p.colNames.length !== this.p.colModel.length) alert(b.jgrid.errors.model);
                        ...
                        var K = function(e, d) {
                            ...
                            ga = function(e, d, i, n, p) {
                                ...
                                if (b.isXMLDoc(e)) {
                                    ...
                                    if (x > 0)
                                        if (a.p.records === 0) a.p.records = V;
                                    H = null;
                                    if (a.p.treeGrid ===
                                        true) try {
                                ...
                                if (e) {
                                    ...
                                    for (; e < N;) {
                                        ...
                                        if (C === undefined) {
                                            C = Z + e;
                                            if (w.length === 0)
                                                if (d.cell) C = b.jgrid.getAccessor(p, d.cell)[s] || C
                                        }
                                        y = i === 1 ? 0 : i;
                                        y = (y + e) % 2 == 1 ? ha : "";
                                    ...
                                    if (a.p.gridview === true) {
                                        ...
                                        else a.p.treeGrid === true && u > 0 ? b(a.rows[u]).after(H.join("")) : b("#" + b.jgrid.jqID(a.p.id) +
                                    ...
                                    a.p.totaltime = new Date - A;
                                    if (t > 0)
                                        if (a.p.records === 0) a.p.records = N;
                        ...
                        var Ca = function(e, d, i, n) {
                                if (a.p.colModel[d].sortable)
                                    if (!(a.p.savedRow.length > 0)) {
                                        ...
                                        if (n)
                                            if (a.p.lastsort == d && a.p.sortorder == n && !i) return;
                            ...
                            Fa = function(e) {
                                ...
                                for (d = i[0] = i[1] = i[2] = 0; d <= e; d++)
                                    if (a.p.colModel[d].hidden === false) i[0] += a.p.colModel[d].width + n;
                            ...
                            b("#cb_" + b.jgrid.jqID(a.p.id), this).bind("click", function() {
                                ...
                                if (this.checked) {
                                    b(a.rows).each(function(e) {
                                        if (e > 0)
                                            if (!b(this).hasClass("subgrid") && !b(this).hasClass("jqgroup") && !b(this).hasClass("ui-state-disabled")) {
                                    ...
                                    b(a.rows).each(function(e) {
                                        if (e > 0)
                                            if (!b(this).hasClass("subgrid") && !b(this).hasClass("ui-state-disabled")) {
                            ...
                            if (b(e.target).closest("th>span.ui-jqgrid-resize").length == 1) {
                                ...
                                if (a.p.forceFit === true) {
                                    var i = a.p,
                                        n = d,
                                        p;
                                    for (p = d + 1; p < a.p.colModel.length; p++)
                        ...
                        b(a).before(g.hDiv).click(function(e) {
                            ...
                            if (i === true) {
                                if (a.p.cellEdit === true)
                                    if (a.p.multiselect && d) b(a).jqGrid("setSelection", R[0].id, true);
                                    else {
                                        ka = R[0].rowIndex;
                                    ...
                                    if (e[a.p.multikey]) b(a).jqGrid("setSelection", R[0].id, true);
                                    else {
                        ...
                        b(g.bDiv).append(b('<div style="position:relative;' + (z && b.browser.version < 8 ? "height:0.01%;" : "") + '"></div>').append("<div></div>").append(this)).addClass("ui-jqgrid-bdiv").css({
                        ...
                        a.updatepager = function(e, d) {
                            ...
                            if (y) {
                                ...
                                if (a.p.viewrecords)
                                    if (a.p.reccount === 0) b(".ui-paging-info", y).html(a.p.emptyrecords);
                                    else {
                                        A = p + 1;
                                        F = a.p.records;
                                        if (b.fmatter) {
    ...
    b.jgrid.extend({
            ...
            return this.each(function() {
                function h(a) {
                    var r = b(c.grid.bDiv)[0].clientHeight,
                        ...
                        z = c.rows[a].offsetTop;
                    a = c.rows[a].clientHeight;
                    if (z + a >= r + v) b(c.grid.bDiv)[0].scrollTop = z - (r + v) + a + v;
                    else if (z < r + v)
                        if (z < v) b(c.grid.bDiv)[0].scrollTop = z
                }
                var c = this,
                    g, k, l;
                if (f !== undefined) {
        ...
        resetSelection: function(f) {
            return this.each(function() {
                ...
                if (typeof f !== "undefined") {
                    ...
                    b(j.p.selarrrow).each(function(g,
                        k) {
                    ...
                    if (b(r).hasClass("jqgrow")) {
                        b("td", r).each(function(v) {
                            ...
                            if (a !== "cb" && a !== "subgrid" && a !== "rn")
                                if (l.p.treeGrid === true && a == l.p.ExpandColumn) j[a] = b.jgrid.htmlDecode(b("span:first", this).html());
                                else try {
                                    j[a] = b.unformat(this, {
                                        rowId: r.id,
                                        colModel: l.p.colModel[v]
                                    }, v)
                                } catch (z) {
            ...
            this.each(function() {
                ...
                if (j) try {
                    ...
                    if (l.p.datatype == "local") {
                        var E = l.p._index[f];
                        if (l.p.treeGrid)
                            for (var P in l.p.treeReader) z.hasOwnProperty(l.p.treeReader[P]) && delete z[l.p.treeReader[P]];
                ...
                if (g)
                    if (v === "string") b(r).addClass(h);
                    else v === "object" && b(r).css(h)
            });
            return g
        },
        addRowData: function(f, j, h, c) {
            ...
            if (j) {
                ...
                this.each(function() {
                    ...
                    if (this.p.altRows === true && !O)
                        if (h == "last")(this.rows.length - 1) % 2 == 1 && b(this.rows[this.rows.length - 1]).addClass(o);
        ...
        footerData: function(f, j, h) {
            function c(r) {
                for (var v in r)
                    if (r.hasOwnProperty(v)) return false;
                return true
            }
            var g, k = false,
                l = {},
        ...
        showHideCol: function(f, j) {
            return this.each(function() {
                ...
                if (h.grid) {
                    ...
                    if (c === true)
                        if (h.grid.width !== h.p.tblwidth) b(h).jqGrid("setGridWidth", h.p.shrinkToFit === true ? h.grid.width : h.p.tblwidth, true)
                }
            })
        },
        hideCol: function(f) {
                    ...
                    if (!isNaN(f)) {
                        ...
                        if (j === true) {
                            ...
                            if (a !== 0) {
                                ...
                                z = f - k * a - E;
                                if (!isNaN(h.p.height))
                                    if (b(h.grid.bDiv)[0].clientHeight < b(h.grid.bDiv)[0].scrollHeight || h.rows.length === 1) {
                                        r = true;
                                        z -= v
                                    }
                                g = 0;
                ...
                if (this.grid) {
                    ...
                    if (l >= 0)
                        if (a = this.rows.namedItem(f)) {
                            ...
                            if (typeof c === "string") b(v).addClass(c);
                            else c && b(v).css(c);
            ...
            return this.each(function() {
                ...
                b(h).keydown(function(c) {
                    var g = b(h).find("tr[tabindex=0]")[0],
                        k, l, a, r = h.p.treeReader.expanded_field;
                    if (g) {
                        a = h.p._index[g.id];
        ...
        if (d) {
            ...
            if (b.fmatter.isString(d))
                for (var i = d.split(";"), j = 0, k = 0; k < i.length; k++) {
                    h = i[k].split(":");
                    if (h.length > 2) h[1] = jQuery.map(h, function(l,
                        o) {
                        if (o > 0) return l
                    }).join(":");
                    if (f) {
                    ...
                    if (f) e = jQuery.map(g, function(l) {
                        return d[l]
                    });
                    else e[0] = d[a] || ""
        }
        ...
        if (c.value) {
            ...
            if (b.fmatter.isString(f))
                for (var h = f.split(";"), i = 0, j = 0; j < h.length; j++) {
                    g = h[j].split(":");
                    if (g.length > 2) g[1] = jQuery.map(g, function(k,
                        l) {
                        if (l > 0) return k
                    }).join(":");
                    if (c) {
        ...
        sortGrid: function(c, h, b) {
            return this.each(function() {
                ...
                if (this.grid) {
                    ...
                    for (var o = 0; o < this.p.colModel.length; o++)
                        if (this.p.colModel[o].index ==
...
(function(a) {
    a.extend(a.jgrid, {
        ...
        viewModal: function(b, c) {
            ...
            if (a.fn.jqm &&
                c.jqm === true) c.jqM ? a(b).attr("aria-hidden", "false").jqm(c).jqmShow() : a(b).attr("aria-hidden", "false").jqmShow();
            else {
                if (c.gbox !== "") {
                ...
                case "custom":
                    ...
                    try {
                        if (a.isFunction(c.custom_element))
                            if (m = c.custom_element.call(this, d, c)) {
        ...
        checkValues: function(b, c, d, f, g) {
            ...
            if (h) {
                j || (j = d.p.colNames[c]);
                if (h.required === true)
                    if (this.isEmpty(b)) return [false, j + ": " + a.jgrid.edit.msg.required, ""];
                f = h.required === false ? false : true;
                if (h.number === true)
                    if (!(f ===
                            false && this.isEmpty(b)))
                        if (isNaN(b)) return [false, j + ": " + a.jgrid.edit.msg.number, ""];
                if (typeof h.minValue != "undefined" && !isNaN(h.minValue))
                    if (parseFloat(b) < parseFloat(h.minValue)) return [false, j + ": " + a.jgrid.edit.msg.minValue + " " + h.minValue, ""];
                if (typeof h.maxValue != "undefined" && !isNaN(h.maxValue))
                    if (parseFloat(b) > parseFloat(h.maxValue)) return [false, j + ": " + a.jgrid.edit.msg.maxValue + " " + h.maxValue, ""];
                if (h.email === true)
                ...
                if (h.time === true)
                    if (!(f === false && this.isEmpty(b)))
                        if (!this.checkTime(b)) return [false, j + ": " + a.jgrid.edit.msg.date + " - hh:mm (am/pm)", ""];
                if (h.url === true)
                    if (!(f === false && this.isEmpty(b))) {
    ...
    a.jgrid.extend({
                ...
                if (l.grid) {
                    ...
                    if (a("#" + z.themodal).html() !== null) b();
                        ...
                        if (a.isFunction(d.onInitializeSearch)) d.onInitializeSearch(a("#" +
                            q));
                        var n = a.extend([], l.p.colModel),
                            s = "<a href='javascript:void(0)' id='" + q + "_search' class='fm-button ui-state-default ui-corner-all fm-button-icon-right ui-reset'><span class='ui-icon ui-icon-search'></span>" + d.Find + "</a>",
                            t = "<a href='javascript:void(0)' id='" + q + "_reset' class='fm-button ui-state-default ui-corner-all fm-button-icon-left ui-search'><span class='ui-icon ui-icon-arrowreturnthick-1-w'></span>" + d.Reset + "</a>",
                            p = "",
                            e = "",
                            u, o = false;
                        ...
                        if (d.columns.length) n = d.columns;
                        else a.each(n, function(f, j) {
                            if (!j.label) j.label = l.p.colNames[f];
                            if (!o) {
                                var G = typeof j.search === "undefined" ? true : j.search,
                                    L = j.hidden === true;
                        ...
                        if (!D && u || d.multipleSearch === false) D = {
                            groupOp: "AND",
                            rules: [{
                                field: u,
                                op: "eq",
                        ...
                        d.layer ? a.jgrid.createModal(z, w, d, "#gview_" + l.p.id, a("#gbox_" + l.p.id)[0], "#" + d.layer, {
                            position: "relative"
                        }) : a.jgrid.createModal(z, w, d, "#gview_" + l.p.id, a("#gbox_" + l.p.id)[0]);
                        ...
                        a("#" + q + "_search").bind("click",
                            function() {
                                ...
                                d.closeAfterSearch && a.jgrid.hideModal("#" + z.themodal, {
                                    gb: "#gbox_" + l.p.id,
                                    jqm: d.jqModal,
                                    onClose: d.onClose
                                });
            ...
            return this.each(function() {
                ...
                function q(g, k, v, r) {
                    ...
                    a(k.p.colModel).each(function(U) {
                        ...
                        if (E !== "cb" && E !== "subgrid" && this.editable === true && E !== "rn") {
                            if (M === false) B = "";
                            else if (E == k.p.ExpandColumn && k.p.treeGrid === true) B = a("td:eq(" + U + ")", k.rows[M]).text();
                            else try {
                                B = a.unformat(a("td:eq(" + U + ")", k.rows[M]), {
                                    rowId: g,
                                    colModel: this
                                }, U)
                            } catch (fa) {
                        ...
                        a(F).each(function() {
                            ...
                            if ((y = a("#" + a.jgrid.jqID(r), "#" + v)) && y[0] !== null) {
                                ...
                                if (K.defaultValue) {
                                    ...
                                    B = a(y).attr("offval")
                                } else if (y[0].type && y[0].type.substr(0, 6) == "select") y[0].selectedIndex = 0;
                                else y.val(B);
                            ...
                            a("td", S).each(function(M) {
                                ...
                                if (r !== "cb" && r !== "subgrid" && r !== "rn" && F[M].editable === true) {
                                    ...
                                    switch (F[M].edittype) {
                                        ...
                                        case "checkbox":
                                            A += "";
                                            if (F[M].editoptions && F[M].editoptions.value)
                                                if (F[M].editoptions.value.split(":")[0] == A) {
                                        ...
                                        case "custom":
                                            try {
                                                if (F[M].editoptions && a.isFunction(F[M].editoptions.custom_value)) F[M].editoptions.custom_value(a("#" + r, "#" + v), "set", A);
                                                else throw "e1";
                                            } catch (U) {
                ...
                function z() {
                    ...
                    if (k[0] && !c.processing) {
                        ...
                        if (h[A] != r.addoper) h[E] = h[e.p.id + "_id"];
                        else if (h[E] === undefined) h[E] = h[e.p.id + "_id"];
                        delete h[e.p.id + "_id"];
                                ...
                                if (k[0] === false) {
                                    ...
                                    if (h[A] == r.addoper) {
                                        ...
                                        if (c.closeAfterAdd) {
                                            ...
                                            if (c.reloadAfterSubmit) a(e).trigger("reloadGrid");
                                            else e.p.treeGrid === true ? a(e).jqGrid("addChildNode", k[2], K, h) : a(e).jqGrid("addRowData", k[2], h, b.addedrow);
                                            C("_empty", e, o)
                                        ...
                                        c.closeAfterEdit && a.jgrid.hideModal("#" + j.themodal, {
                                            gb: "#gbox_" + u,
                                            jqm: b.jqModal,
                                            onClose: c.onClose
                                        })
                                    ...
                                    if (c.checkOnSubmit || c.checkOnUpdate) {
                                        ...
                                        if (c._savedData[e.p.id + "_id"] != "_empty")
                                            for (var S in c._savedData)
                                                if (h[S]) c._savedData[S] = h[S]
                                    }
                                }
                                c.processing = false;
                        ...
                        if (!v.url && !c.useDataProxy)
                            if (a.isFunction(e.p.dataProxy)) c.useDataProxy = true;
                            else {
                                k[0] = false;
                ...
                function w() {
                    a.each(e.p.colModel, function(g, k) {
                        if (k.editoptions && k.editoptions.NullIfEmpty === true)
                            if (h.hasOwnProperty(k.name) && h[k.name] == "") h[k.name] = "null"
                    })
                }
                ...
                function s() {
                    if (d !== "_empty" && typeof e.p.savedRow !== "undefined" && e.p.savedRow.length > 0 && a.isFunction(a.fn.jqGrid.restoreRow))
                        for (var g = 0; g < e.p.savedRow.length; g++)
                            if (e.p.savedRow[g].id == d) {
                ...
                if (e.grid && d) {
                    var u = e.p.id,
                        ...
                        G = a.isFunction(c.beforeShowForm) ? c.beforeShowForm : false,
                        L = a.isFunction(c.afterShowForm) ? c.afterShowForm : false,
                        I = a.isFunction(c.beforeInitData) ? c.beforeInitData : false,
                        T = a.isFunction(c.onInitializeForm) ? c.onInitializeForm : false,
                        H = true,
                        m = 1,
                        x = 0,
                        h, P, O, V;
            ...
            return this.each(function() {
                ...
                function q(m, x, h, P) {
                    ...
                    a(x.p.colModel).each(function() {
                        ...
                        if (!V && this.align === "right")
                            if (this.formatter && a.inArray(this.formatter, g) !== -1) k = Math.max(k, parseInt(this.width, 10));
                    ...
                    a(x.p.colModel).each(function(K) {
                        ...
                        if (O !== "cb" && O !== "subgrid" && O !== "rn" && A) {
                            ...
                            var B = a.extend({}, {
                                ...
                                N = parseInt(B.rowpos, 10) || J + 1,
                                F = parseInt((parseInt(B.colpos, 10) || 1) * 2, 10);
                            if (B.rowabove) {
        ...
        delGridRow: function(d, b) {
            ...
            return this.each(function() {
                ...
                if (l.grid)
                    if (d) {
                        var q = typeof b.beforeShowForm === "function" ? true : false,
                            C = typeof b.afterShowForm === "function" ? true : false,
                        ...
                        if (a("#" + o.themodal).html() !== null) {
                            ...
                            a("#dData", "#" + s + "_2").click(function() {
                                ...
                                if (j[0] && !c.processing) {
                                    ...
                                    t[p] = G;
                                    var L = a.extend({
                                        url: c.url ? c.url : a(l).jqGrid("getGridParam", "editurl"),
                                        type: b.mtype,
                                        ...
                                        complete: function(I, T) {
                                            ...
                                            if (j[0] === false) {
                                                ...
                                                if (c.reloadAfterSubmit && l.p.datatype != "local") a(l).trigger("reloadGrid");
                                                else {
                                                    var H = [];
                                                    H = G.split(",");
                                                    if (l.p.treeGrid === true) try {
                                                        ...
                                                        for (var x = 0; x < H.length; x++) a(l).jqGrid("delRowData", H[x]);
                                                    l.p.selrow = null;
                                                    l.p.selarrrow = []
                                                }
                                            ...
                                            j[0] && a.jgrid.hideModal("#" + o.themodal, {
                                                gb: "#gbox_" + D,
                                                jqm: b.jqModal,
                                                onClose: c.onClose
                                            })
                                    ...
                                    if (!L.url && !c.useDataProxy)
                                        if (a.isFunction(l.p.dataProxy)) c.useDataProxy = true;
                                        else {
                                            j[0] = false;
                            ...
                            if (b.edit) {
                                ...
                                a(p, e).attr({
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var f = n.p.selrow;
                                        if (f) typeof b.editfunc == "function" ? b.editfunc(f) : a(n).jqGrid("editGridRow", f, l);
                                        else {
                            ...
                            if (b.view) {
                                ...
                                a(p, e).attr({
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        var f =
                                            n.p.selrow;
                                        if (f) a(n).jqGrid("viewGridRow", f, D);
                                        else {
                                            a.jgrid.viewModal("#" + w.themodal, {
                                                gbox: "#gbox_" + n.p.id,
                                                jqm: true
                            ...
                            if (b.del) {
                                ...
                                a(p,
                                    ...
                                    if (!a(this).hasClass("ui-state-disabled")) {
                                        ...
                                        if (f) "function" == typeof b.delfunc ? b.delfunc(f) : a(n).jqGrid("delGridRow", f, C);
                                        else {
                                            a.jgrid.viewModal("#" + w.themodal, {
                                                gbox: "#gbox_" + n.p.id,
                                                jqm: true
                ...
                if (this.grid) {
                    ...
                    if (l)
                        if (!(b.id && a("#" + b.id, l).html() !== null)) {
                            ...
                            if (b.position == "first") l.rows[0].cells.length === 0 ? a("tr", l).append(C) : a("tr td:eq(0)", l).before(C);
                            else a("tr", l).append(C);
        ...
        GridToForm: function(d, b) {
            return this.each(function() {
                if (this.grid) {
                    ...
                    if (l)
                        for (var q in l) a("[name=" + a.jgrid.jqID(q) + "]", b).is("input:radio") || a("[name=" +
        ...
        FormToGrid: function(d, b, l, q) {
            return this.each(function() {
                if (this.grid) {
                    l || (l = "set");
                    q || (q = "first");
                    var C = a(b).serializeArray(),
                        z = {};
                    a.each(C, function(D, w) {
                        z[w.name] = w.value
                    });
                    if (l == "add") a(this).jqGrid("addRowData", d, z, q);
                    else l == "set" && a(this).jqGrid("setRowData", d, z)
                }
            })
        }
    })
...
(function(d) {
    d.fn.jqFilter = function(k) {
        ...
        return this.each(function() {
            if (!this.filter) {
                ...
                var p, u = this.p.columns.length,
                    i, v = /msie/i.test(navigator.userAgent) && !window.opera;
                if (this.p._gridsopt.length)
                    for (p = 0; p < this.p._gridsopt.length; p++) this.p.ops[p].description = this.p._gridsopt[p];
                ...
                if (u) {
                    ...
                    var w = function(c, f) {
                        var a = [true, ""];
                        if (d.isFunction(f.searchrules)) a = f.searchrules(c, f);
                        else if (d.jgrid && d.jgrid.checkValues) try {
                    ...
                    this.createTableForGroup = function(c, f) {
                        var a = this,
                            b, e = d("<table class='group ui-widget ui-widget-content' style='border:0px none;'><tbody></tbody></table>");
                        ...
                        g.bind("click", function() {
                            ...
                            for (b = 0; b < a.p.columns.length; b++) {
                                var n = typeof a.p.columns[b].search ===
                                    "undefined" ? true : a.p.columns[b].search,
                                    r = a.p.columns[b].hidden === true;
                        ...
                        if (c.rules !== undefined)
                            for (b = 0; b < c.rules.length; b++) e.append(this.createTableRowForRule(c.rules[b], c));
                        return e
                    };
                    this.createTableRowForRule = function(c, f) {
                        ...
                        r.bind("change", function() {
                            ...
                            for (e = 0; e < a.p.columns.length; e++)
                                if (a.p.columns[e].name === c.field) {
                                    h = a.p.columns[e];
                                    break
                                }
                            if (h) {
                                h.searchoptions.id = d.jgrid.randId();
                                if (v && h.inputtype === "text")
                                    if (!h.searchoptions.size) h.searchoptions.size = 10;
                                ...
                                var x = "",
                                    y = "";
                                for (e = 0; e < a.p.ops.length; e++)
                                    if (d.inArray(a.p.ops[e].name, g) !== -1) {
                    ...
                    this.getStringForRule = function(c) {
                        ...
                        for (b = 0; b < this.p.ops.length; b++)
                            if (this.p.ops[b].name === c.op) {
                                f = this.p.ops[b].operator;
                                a = this.p.ops[b].name;
                                break
                            }
                        for (b = 0; b < this.p.columns.length; b++)
                            if (this.p.columns[b].name === c.field) {
                                e = this.p.columns[b];
                                break
                            }
                        b = c.data;
                            ...
                            if (a.rules !== undefined)
                                for (e = 0; e < a.rules.length; e++) {
                                    ...
                                    if (f.p.errorcheck) {
                                        var j = void 0,
                                            h = void 0;
                                        for (j = 0; j < f.p.columns.length; j++)
                                            if (f.p.columns[j].name === g.field) {
                                                h =
                                                    f.p.columns[j];
                                                break
                                            }
    ...
    d.extend(d.fn.jqFilter, {
        ...
        getParameter: function(k) {
            if (k !== undefined)
                if (this.p.hasOwnProperty(k)) return this.p[k];
            return this.p
        },
...
(function(a) {
    a.jgrid.extend({
        editRow: function(e, x, l, r, t, y, u, j, s) {
            var f = {
                    keys: x || false,
                    oneditfunc: l || null,
                    successfunc: r || null,
                            ...
                            a("td", k).each(function(h) {
                                ...
                                if (c != "cb" && c != "subgrid" && c != "rn") {
                                    ...
                                    if (g[h].editable === true) {
                                        ...
                                        var i = a.extend({}, g[h].editoptions || {}, {
                                            id: e + "_" + c,
                                            name: c
                                        });
            ...
            if (j === "1") {
                ...
                a("td", k).each(function(n) {
                    ...
                    if (d != "cb" && d != "subgrid" && g.editable === true && d != "rn" && !a(this).hasClass("not-editable-cell")) {
                        ...
                        if (f.url !== "clientArray" && g.editoptions && g.editoptions.NullIfEmpty === true)
                            if (c[d] == "") v[d] = "null"
                    }
                });
                if (p[0] === false) {
                ...
                if (f.url == "clientArray") {
                    ...
                    a.ajax(a.extend({
                        ...
                        complete: function(n,
                            ...
                            a("#lui_" + b.p.id).hide();
                            if (i === "success")
                                if ((a.isFunction(f.succesfunc) ? f.succesfunc.call(b, n) : true) === true) {
                        ...
                        error: function(n, i) {
                            a("#lui_" + b.p.id).hide();
                            if (a.isFunction(f.errorfunc)) f.errorfunc.call(b, e, n, i);
                            else try {
        ...
        restoreRow: function(e, x) {
            return this.each(function() {
                ...
                if (l.grid) {
                    ...
                    if (t !== false) {
                        for (var u = 0; u < l.p.savedRow.length; u++)
                            if (l.p.savedRow[u].id == e) {
                                r = u;
                                break
                            }
                        if (r >= 0) {
            ...
            return this.each(function() {
                ...
                if (!(!c.grid || c.p.cellEdit !== true)) {
                    ...
                    if (c.p.savedRow.length > 0) {
                        if (a === true)
                            if (d == c.p.iRow && e == c.p.iCol) return;
                    ...
                    if (!(h == "subgrid" || h == "cb" || h == "rn")) {
                        ...
                        if (c.p.colModel[e].editable === true && a === true && !g.hasClass("not-editable-cell")) {
                            ...
                            b("input, select, textarea", g).bind("keydown", function(l) {
                                if (l.keyCode === 27)
                                    if (b("input.hasDatepicker", g).length > 0) b(".ui-datepicker").is(":hidden") ? b(c).jqGrid("restoreCell", d, e) : b("input.hasDatepicker", g).datepicker("hide");
                    ...
                    if (c !== null) {
                        ...
                        if (g != a.p.savedRow[c].v) {
                            if (b.isFunction(a.p.beforeSaveCell))
                                if (c = a.p.beforeSaveCell.call(a, a.rows[d].id, j, f, d, e)) g = f = c;
                                    ...
                                    if (a.p.cellurl) {
                                        ...
                                        b.ajax(b.extend({
                                            ...
                                            data: b.isFunction(a.p.serializeCellData) ?
                                                a.p.serializeCellData.call(a, n) : n,
                                            type: "POST",
                                            complete: function(o, p) {
                                                b("#lui_" + a.p.id).hide();
                                                a.grid.hDiv.loading = false;
                                                if (p == "success")
                                                    if (b.isFunction(a.p.afterSubmitCell)) {
        ...
        nextCell: function(d, e) {
            return this.each(function() {
                ...
                if (!(!this.grid ||
                    ...
                    for (var c = e + 1; c < this.p.colModel.length; c++)
                        if (this.p.colModel[c].editable === true) {
                            a = c;
                            break
                        }
                    if (a !== false) b(this).jqGrid("editCell", d, a, true);
                    else this.p.savedRow.length > 0 && b(this).jqGrid("saveCell", d, e)
                }
            })
        },
        prevCell: function(d, e) {
            return this.each(function() {
                ...
                if (!(!this.grid || this.p.cellEdit !== true)) {
                    ...
                    if (a !== false) b(this).jqGrid("editCell", d, a, true);
                    else this.p.savedRow.length > 0 && b(this).jqGrid("saveCell",
                        d, e)
                }
            })
        },
                ...
                function d(g, k, j) {
                    if (j.substr(0, 1) == "v") {
                        var i = b(a.grid.bDiv)[0].clientHeight,
                            ...
                            m = a.rows[g].offsetTop + a.rows[g].clientHeight,
                            q = a.rows[g].offsetTop;
                        if (j == "vd")
                            if (m >= i) b(a.grid.bDiv)[0].scrollTop = b(a.grid.bDiv)[0].scrollTop + a.rows[g].clientHeight;
                        if (j == "vu")
                            if (q < l) b(a.grid.bDiv)[0].scrollTop = b(a.grid.bDiv)[0].scrollTop - a.rows[g].clientHeight
                    }
                    if (j == "h") {
...
(function(b) {
    ...
    var l =
        ...
        r = function(a) {
            ...
            if (q)
                if (a.o) a.o.html('<p style="width:100%;height:100%"/>').prepend(f);
                    ...
                    if (!this[c]) {
                        ...
                        b(this).click(function() {
                            for (var i in {
                                ...
                                for (var g in this[i])
                                    if (j[this[i][g]]) j[this[i][g]].w[i](this);
                            return e
                        })
                    }
                    this[c].push(d)
            ...
            return this.each(function() {
                ...
                if (a.grid) {
                    var j = function(i, d, e) {
                        ...
                        q = function(i, d) {
                            var e, c, g, k = b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                                h = b("<tr></tr>");
                            ...
                            if (i) {
                                ...
                                b(g.root + " " + g.row, i).each(function() {
                                    ...
                                    if (g.repeatitems === true) b(g.cell, this).each(function(m) {
                                        ...
                                        if (n)
                                            for (c = 0; c < n.length; c++) j(h, b(n[c], this).text() || "&#160;", c)
                                    }
                                    b(k).append(h)
                                })
                            }
                        ...
                        r = function(i, d) {
                            var e,
                                c, g, k, h, n = b("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                                m = b("<tr></tr>");
                            for (c = 0; c < a.p.subGridModel[0].name.length; c++) {
                                e = b("<th class='ui-state-default ui-th-subgrid ui-th-column ui-th-" + a.p.direction + "'></th>");
                                b(e).html(a.p.subGridModel[0].name[c]);
                                ...
                                if (typeof e !== "undefined")
                                    for (c = 0; c < e.length; c++) {
                                        ...
                                        if (k.repeatitems === true) {
                                            ...
                                            if (t.length)
                                                for (h = 0; h < t.length; h++) j(m, g[t[h]] || "&#160;", h)
                                        }
                                        b(n).append(m)
                                    }
                            }
                            ...
                            if (a.p.subGridModel[0].params)
                                for (g = 0; g < a.p.subGridModel[0].params.length; g++)
                                    for (c = 0; c < a.p.colModel.length; c++)
                                        if (a.p.colModel[c].name == a.p.subGridModel[0].params[g]) e[a.p.colModel[c].name] = b("td:eq(" + c + ")", i).text().replace(/\&#160\;/ig, "");
                            if (!a.grid.hDiv.loading) {
                                a.grid.hDiv.loading = true;
                                b("#load_" + a.p.id).show();
                        ...
                        if (b(d).hasClass("jqgrow")) {
                            b(this.cells[f]).bind("click", function() {
                                ...
                                if (b(this).hasClass("sgcollapsed")) {
                                    ...
                                    if (o === false) return false;
                                    if (a.p.subGridOptions.reloadOnExpand === true) b(p).remove(".ui-subgrid");
                                    else b(p).hasClass("ui-subgrid") && b(p).hide();
                ...
                if (this.grid || f)
                    if (this.p.subGrid === true) {
                        ...
                        if (a) {
                            ...
                            if (j) b(j).trigger("click");
                            else(j = b("td.sgexpanded", a)[0]) && b(j).trigger("click")
                        }
                    }
            })
        }
                ...
                if (a !== null && (typeof a === "object" || e.isFunction(a)))
                    if (a.groupField.length) {
                        ...
                        for (var b = 0; b < a.groupField.length; b++) {
                            ...
                            if (a.groupSummary[b]) {
                                a.summary[b] = [];
                                for (var c = this.p.colModel, d = 0, g = c.length; d < g; d++) c[d].summaryType && a.summary[b].push({
                                    nm: c[d].name,
                                    st: c[d].summaryType,
                                    v: ""
                                })
        ...
        setTreeNode: function(b, c) {
            return this.each(function() {
                ...
                if (a.grid && a.p.treeGrid)
                    for (var e = a.p.expColInd, g = a.p.treeReader.expanded_field, h = a.p.treeReader.leaf_field, f = a.p.treeReader.level_field, k = a.p.treeReader.icon_field, i = a.p.treeReader.loaded, j, o, n, l; b < c;) {
            ...
            return this.each(function() {
                ...
                if (this.grid && this.p.treeGrid) {
                    ...
                    if (k !== undefined) {
                        ...
                        if (k.length > 0)
                            for (var i = 0; i < k.length; i++) d(this).jqGrid("delRowData", k[i][c]);
                        if (this.p.treeGridModel === "nested") {
                            c = d.jgrid.from(this.p.data).greater(a, g, {
                                stype: "integer"
                            }).select();
                            if (c.length)
                                for (f in c) c[f][a] = parseInt(c[f][a],
                                    10) - h;
...
var xmlJsonClass = {
    ...
    json2xml: function(a, b) {
        var g = function(d, c, i) {
                ...
                if (d instanceof Array)
                    if (d.length === 0) h += i + "<" + c + ">__EMPTY_ARRAY_</" + c + ">\n";
                    else {
                        k = 0;
            ...
            if (a.firstChild) {
                ...
                if (d)
                    if (e < 2 && f < 2) {
                        this.removeWhite(a);
                        for (c =
                            a.firstChild; c; c = c.nextSibling)
                            if (c.nodeType === 3) b["#text"] = this.escape(c.nodeValue);
                            else if (c.nodeType === 4)
                            if (g.test(c.nodeValue)) b[c.nodeName] = [b[c.nodeName], c.nodeValue];
                            else b["#cdata"] = this.escape(c.nodeValue);
                        else if (b[c.nodeName])
                            if (b[c.nodeName] instanceof Array) b[c.nodeName][b[c.nodeName].length] = this.toObj(c);
                    ...
                    if (a.attributes.length) b["#text"] = this.escape(this.innerXml(a));
                    else {
    ...
    toJson: function(a, b, g, e) {
        ...
        if (a === "[]") f += b ? ":[]" : "[]";
            ...
            i = [];
            for (h in a)
                if (a.hasOwnProperty(h)) i[i.length] = this.toJson(a[h], h, g + d, e);
    ...
    jQuery(n).each(function() {
        if (!this.grid) {
            ...
            for (a = 0; a < f.length; a++) {
                b = null;
                if (h.length > 0)
                    if ((b = h[a]) && b.replace) b = encodeURIComponent(b).replace(/[.\-%]/g, "_");
                if (b === null) b = a + 1;
...
(function(a) {
    ...
    a.jgrid.extend({
        ...
        columnChooser: function(b) {
            function g(d, l) {
                if (d)
                    if (typeof d == "string") a.fn[d] && a.fn[d].apply(l, a.makeArray(arguments).slice(2));
                    else a.isFunction(d) && d.apply(l, a.makeArray(arguments).slice(2))
            }
            var c = this;
            if (!a("#colchooser_" + c[0].p.id).length) {
                ...
                a.each(h, function(d) {
                    i[this.name] = d;
                    if (this.hidedlg) this.hidden || m.push(d);
                                            ...
                                            drop: function(h, j) {
                                                if (a(j.draggable).hasClass("jqgrow")) {
                                                    ...
                                                    if (!e.dropbyname) {
                                                        var m = 0,
                                                            k = {},
                                                            d, l = a("#" + this.id).jqGrid("getGridParam", "colModel");
                                                        try {
                                                            for (var p in i) {
