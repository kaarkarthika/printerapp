		...
		return this.each(function() {
			...
			function t(d) {
				...
				if (c.transitionEffect == "slide")
					a(a(g, b).attr("id"), b).slideUp("fast", function() {
						a(a(e, b).attr("id"), b).slideDown("fast");
						h = d;
						r(g, e)
					});
				else if (c.transitionEffect == "fade")
					a(a(g, b).attr("id"), b).fadeOut("fast", function() {
						a(a(e, b).attr("id"), b).fadeIn("fast");
						h = d;
						r(g, e)
					});
					...
					a(a(g, b).attr("id"), b).hide(), a(a(e, b).attr("id"), b).show(), h = d, r(g, e);
				return !0
			}
