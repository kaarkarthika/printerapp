	...
	public function actionTemptabletindividual($id)
    {
			...
			if(!empty($Sale_detail))
			{
				...
				foreach ($Sale_detail as $key => $value)
				{
					...
					$result_string1.='<td><div class="input-group"> <input type="text"  readonly="readonly" name="discount_value[]" data_disc_value='.$value['stockresponseid'].' id="enabledisc'.$value['stockresponseid'].'" value="'.$value['discountvalue'].'" class="enabledisc disctxt w-50" readonly></div>
					...
					$result_string1.='<td class="w-xss"><input type="hidden" class="form-control" data_gst_percent='.$value['stockresponseid'].' name="gst_percent[]" id="gst_percent'.$value['stockresponseid'].'" value="'.$value['gstrate'].'">
														<input type="text" name="discountext_value[]" value="'.$value['discountvalueperquantity'].'" readonly="readonly" id="disc_amount'.$value['stockresponseid'].'" class="add_discount text-right disctxt w-50" readonly>
...
//echo"<pre>";print_r($saledata->paid_amt); die;
//New Code
...
$headertable='<table cellspacing="0" cellpadding="1" >';
$headertable.='<tr ><td style="text-align:center;font-size:18px;" colspan="12" ><b>'.strtoupper($companyname).'</b></td></tr>';
$headertable.='<tr ><td style="text-align:center;font-size:12px;" colspan="12" ><b>'.$title.'</b></td></tr>';
$headertable.='<tr ><td style="text-align:center;font-size:12px;" colspan="12" ><p><b>'.strtoupper($address).'-'.$companybranchdata->pincode.'</b></p></td></tr>';
$headertable.='<tr><td colspan="3"><b>DL NO - '.$companydata->dln1.'</b></td><td colspan="3">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>'.$companydata->dln2.'</b></td>
<td colspan="3"><b>&nbsp;&nbsp;&nbsp;'.$companydata->dln3.'</b></td><td colspan="3"><b>GSTIN : '.$gstin.'</b></td></tr>';
...
$tbl1.='<tr>
	...
	<td width="206">
		<table>
		  	<tr>
				<td style="font-size:10px;">'.number_format($totalcgstrate,2).'</td>
				<td style="">'.number_format($saledata->totalcgstvalue,2).'</td>
				<td style="font-size:10px;">'.number_format($totalsgstrate,2).'</td>
...
<tr>
	<td colspan="8" style="text-align:right;"><b>Paid Amount</b></td>
	<td>'.number_format($saledata->paid_amt,2).'</td>
</tr>
<tr>
	<td colspan="8" style="text-align:right;"><b>Due Amount</b></td>
